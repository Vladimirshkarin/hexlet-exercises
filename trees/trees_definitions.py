...
#  которые в свою очередь могут быть также
# деревьями или списками. Например:
...
# solution.py
# Реализуйте функцию remove_first_level().
#  Она должна принимать на вход дерево и возвращать новое дерево,
#  элементами которого являются потомки вложенных узлов:
